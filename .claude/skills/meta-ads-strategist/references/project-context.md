...
**Проверено вживую (2026-07-02):** полный цикл — форма `997344736498919` (EN) →
видео → креатив → кампания `120250357368240233` → адсет (€10/день, GB) → ад;
лид через webhook → CRM lead #3870 (`source_channel=meta`).
